		...
		<div id="content">	
			<div class="card">
				<div class="card-header">
					<h1 align="center">Revisi Pengajuan RKAT</h1>
				</div> 
				<div class="card-body">
					<div class="card" id="uhuy">
						<h4 align="center">Revisi RKAT Dari BAUK</h4>
						<table class="table table-bordered table-hover">
							<tr class="table-primary">
								<th>No</th>
								<th>Hal Yang DiRevisi</th>
								<th>Keterangan</th>
							</tr>
							<tr>
								<td>1</td>
								<td>Pada Kategori A</td>
								<td>Pensil tidak dapat diajukan</td>
							</tr>
						</table>
					...
					<br>
					<button type="submit" class="btn btn-primary float-right" name="upload">Update</button>
